...
% TODO: remove all of this 'next section' crap and make it more clear
The next section describes the physical simulation of the quadcopter. 
Following this is an overview of the control theory used in developing the control system, including standard PD control, adaptive control, and adaptive control in a simulated biological neural system. 
...
The final section discusses the results and outline areas of future work.
